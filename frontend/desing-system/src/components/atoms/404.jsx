...
export default ({ classChild, classDad }) => (
  <div className={classDad}>
    <svg className={classChild} width="840" height="727" viewBox="0 0 840 727">
      <defs>
        <linearGradient
      ...
      <ellipse cx="432" cy="132.31" rx="143.21" ry="110.94" fill="#a400ff" />
      <path
